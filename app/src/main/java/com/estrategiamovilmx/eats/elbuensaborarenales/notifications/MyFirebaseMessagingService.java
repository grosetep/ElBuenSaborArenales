package com.estrategiamovilmx.eats.elbuensaborarenales.notifications;
...
import com.estrategiamovilmx.eats.elbuensaborarenales.ui.activities.FCMPluginActivity;
import com.estrategiamovilmx.eats.elbuensaborarenales.ui.activities.ReplyActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public static final String CHANNEL_ID = "buensabor_chanel";
    /**
    ...
    private void sendNotification(Map<String, String> data ) {
        ...
        if (user!=null) {
            ...
            Log.d(TAG, "Notificacion para Usuario no registrado:");
            notificationBuilder = makeSimpleNotification(user,data);
        }
