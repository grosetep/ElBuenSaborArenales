...
public class Constants {
    ...
    public static final String SUBDOMAIN = "/elbuensaborarenales/services/services.php/";
    public static final String MENBERS_DOMAIN_REST =Constants.HTTP + Constants.IP + Constants.PUERTO_HOST + "/members/services/services.php/";
    public static final String RETROFIT_SERVICE_REST = Constants.HTTP + Constants.IP + Constants.PUERTO_HOST + Constants.SUBDOMAIN;
    /**
     * URLs del Web Service
     */
    /*Products*/
    public static final String GET_PRODUCTS = HTTP + IP + PUERTO_HOST + "/elbuensaborarenales/services/getProducts.php";
    /* Upload images*/
    public static final String UPLOAD_IMAGE = HTTP + IP + PUERTO_HOST + "/elbuensaborarenales/services/uploadImage.php";
    ...
    public static final String PACKAGE_NAME =
            "com.estrategiamovilmx.eats.elbuensaborarenales";
    ...
    public static final String seedValue = "eats120220182130";
    public static final String reset_password = "quelenteja108322";
    ...
    /* profiles user*/
    public static final String app_label = "buensabor_";
    ...
    public static final String merchant_key = "merchant_12022018_elbuensabor_peru";
