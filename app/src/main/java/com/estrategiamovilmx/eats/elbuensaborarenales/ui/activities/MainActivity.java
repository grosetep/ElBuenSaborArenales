...
import com.estrategiamovilmx.eats.elbuensaborarenales.ui.fragments.OfferFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    private void setupViewPager(ViewPager viewPager) {
       ...
       // adapter.addFragment(MenuFragment.createInstance("init"),"MENU");
        ...
        adapter.addFragment(ProductsFragment.createInstance(null),"MENU");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_login) {
            ...
            if (user != null && user.getIdUser() != null) {
                ...
                i.putExtra(Constants.flow, MainActivity.flow_main);
                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(i);
            }
