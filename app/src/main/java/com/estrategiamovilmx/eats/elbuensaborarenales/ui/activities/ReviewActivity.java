...
import com.estrategiamovilmx.eats.elbuensaborarenales.items.ConfigItem;
...
import com.estrategiamovilmx.eats.elbuensaborarenales.model.ShoppingCart;
...
public class ReviewActivity extends AppCompatActivity {
    ...
    private void setValues(){
        ...
        if (payment_method.getIdPaymentMethod().equals(String.valueOf(Constants.CASH))) {
            text_payment_extra_info.setText(getString(R.string.promt_money_back_data, StringOperations.getAmountFormat(payment_method.getMoneyBack())));
        }
