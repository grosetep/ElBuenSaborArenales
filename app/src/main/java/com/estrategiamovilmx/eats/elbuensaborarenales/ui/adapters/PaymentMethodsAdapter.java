...
import com.estrategiamovilmx.eats.elbuensaborarenales.ui.activities.PaymentMethodActivity;
...
public class PaymentMethodsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(PaymentMethod model) {
            ...
            text_extra_info.setText(model.getMoneyBack()!=null && !model.getMoneyBack().isEmpty()?activity.getString(R.string.promt_money_back_data, StringOperations.getAmountFormat(model.getMoneyBack())):"");
