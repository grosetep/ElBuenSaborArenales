...
import com.estrategiamovilmx.eats.elbuensaborarenales.ui.activities.ShippingActivity;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ShippingAddress model) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                Drawable clone_location = ContextCompat.getDrawable(activity, R.drawable.ic_location_on).getConstantState().newDrawable().mutate();
                if (model.isSelected()){
                    image.setImageDrawable(GeneralFunctions.getTintedDrawable(clone_location, R.color.colorAccent,activity));
                } else if (model.isNew()){
                    image.setImageDrawable(GeneralFunctions.getTintedDrawable(clone_location, android.R.color.holo_green_light,activity));
                }
                else {image.setImageDrawable(GeneralFunctions.getTintedDrawable(clone_location, R.color.gray, activity));}

            }else{
                image.setImageResource(R.drawable.ic_location_on);
                if (model.isSelected()){
        ...
        if(holder instanceof ShippingAddressAdapter.ViewHolder) {
            ...
            p_holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Log.d(TAG, "before---------    ship.isNew():" + ship.isNew() + " isSelected:" + ship.isSelected());
