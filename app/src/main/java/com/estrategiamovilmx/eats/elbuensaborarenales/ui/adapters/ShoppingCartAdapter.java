...
import com.estrategiamovilmx.eats.elbuensaborarenales.items.CartProductItem;
...
public class ShoppingCartAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(CartProductItem model) {
            ...
            text_price.setText(model.getOfferPrice() != null && !model.getOfferPrice().isEmpty() ? StringOperations.getAmountFormat(model.getOfferPrice()) + " X " + model.getUnits() : StringOperations.getAmountFormat(model.getRegularPrice()) + " X " + model.getUnits());
            //variante
            ...
            text_total.setText("Total " + StringOperations.getAmountFormat(model.getTotal()));
