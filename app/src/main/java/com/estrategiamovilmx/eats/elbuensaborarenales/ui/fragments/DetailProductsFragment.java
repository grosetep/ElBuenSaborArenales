...
import com.estrategiamovilmx.eats.elbuensaborarenales.model.DetailPublication;
import com.estrategiamovilmx.eats.elbuensaborarenales.model.ImageSliderPublication;
import com.estrategiamovilmx.eats.elbuensaborarenales.model.ProductModel;
...
import com.estrategiamovilmx.eats.elbuensaborarenales.tools.VolleyErrorHelper;
import com.estrategiamovilmx.eats.elbuensaborarenales.ui.activities.AddToCartActivity;
import com.estrategiamovilmx.eats.elbuensaborarenales.ui.activities.GalleryActivity;
...
import com.estrategiamovilmx.eats.elbuensaborarenales.ui.activities.ShoppingCartActivity;
            ...
            switch (message) {
                case "1"://assign values
                    ...
                    if (detail.getOfferPrice()!=null && !detail.getOfferPrice().isEmpty()) {//mostrar precio exacto
                        text_price.setText(StringOperations.getStringWithA(StringOperations.getAmountFormat(detail.getOfferPrice())));
                    }else{
                        text_price.setText(StringOperations.getStringWithA(StringOperations.getAmountFormat(detail.getRegularPrice())));
                    }
