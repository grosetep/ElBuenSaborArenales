...
import com.estrategiamovilmx.eats.elbuensaborarenales.ui.activities.OrderDetailActivity;
import com.estrategiamovilmx.eats.elbuensaborarenales.ui.adapters.PendingOrdersAdapter;
...
public class PendingOrdersFragment extends Fragment {
    ...
    private void processResponseInit(retrofit2.Response<GetOrdersResponse> response){
        ...
        if (orders_response != null && orders_response.getStatus().equals(Constants.success)) {
            Log.d(TAG,"Pedidos:");
            for(OrderItem o:orders_response.getResult()){
